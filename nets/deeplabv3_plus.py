...
class DeepLab(nn.Module):
    def __init__(
        ...
        if backbone == "deeplabv3plus_fusion":
            ...
            # ASPP模块融合后输出的通道数量
            aspp_channels = 256 if self.aspp_module else stage1_channels
        else:
            raise ValueError(
        ...
        self.cls_conv_simplify = nn.Conv2d(
            in_channels=aspp_channels, out_channels=num_classes, kernel_size=1
        )
